...
public class V8ScriptTemplateView extends AbstractUrlBasedView {
  ...
  private void setResourceLoaderPath (String resourceLoaderPath) {
  ...
  protected void renderMergedOutputModel (Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    System.out.println("messagess=" + JsonUtil.toJson(messageMap));
  ...
  private V8ScriptTemplateConfig autodetectViewConfig () throws BeansException {
    try {
